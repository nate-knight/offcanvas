...
$(document).ready(function () {
    ...
    function buildNode(key, val) {
        ...
        if (val.menuTitle) {
            ...
            html += '<a href="' + (val.url ?  val.url + document.location.search : '#') + '">' + val.menuTitle + '</a>';
            ...
            if (val.submenus) {
                ...
                //category title
                html += '<li class="mp-cat-title"><a href="' + (val.url ?  val.url + document.location.search :  '#') +  '">' + val.menuTitle + '</a></li>';
